...
const assetsPath = "./js/assets/";
const path = require('path');
const buildPath = path.resolve(__dirname, "./build/");
const nodemodulesPath = path.resolve(__dirname, './node_modules/');
const port = 3000; //devServer端口号
const publicPath = '/';
    ...
    plugins: [
        ...
        */
        ...
        new HappyPack({
            id: 'css',
            threadPool: happyThreadPool,
            loaders: ['style-loader!css-loader?outputStyle=expanded'],
            cache: true,
            verbose: true
        }),
        ...
        new HappyPack({
            id: 'assets',
            threadPool: happyThreadPool,
            loaders: ['url-loader!file-loader?limit=25000&name=pic/[name].[ext]'],
            cache: true,
            verbose: true
        }),
        ...
        new HappyPack({
            id: 'assets',
            threadPool: happyThreadPool,
            loaders: ['file-loader?limit=25000&name=pic/[name].[ext]'],
            cache: true,
            verbose: true
        }),
        */
